...
# ==============================================================
# 2. Configuration du logging JSON (flush immédiat)
# ==============================================================
# Utilisation du dossier passé en variable d'environnement ou par défaut dans Docker
...
def log_to_json(entry: dict):
    """Enregistre une ligne JSON dans le fichier de logs immédiatement (flush en temps réel)."""
    with open(LOG_FILE, "a", encoding="utf-8", buffering=1) as f:  # line-buffered
        json.dump(entry, f)
        f.write("\n")
        f.flush()
